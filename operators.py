...
class SelectByFaceIDOperator(bpy.types.Operator):
    ...
    bl_description = "Select the Plasticity face"
...
class SelectByFaceIDEdgeOperator(bpy.types.Operator):
    ...
    bl_description = "Select the boundary edges of the Plasticity face"
    bl_options = {'REGISTER', 'UNDO'}
...
class MergeUVSeams(bpy.types.Operator):
    ...
    bl_description = "Merge UV seams along the boundary of the selected faces or edges"
    bl_options = {'REGISTER', 'UNDO'}
...
class PaintPlasticityFacesOperator(bpy.types.Operator):
    ...
    bl_description = "Assign a unique vertex color and material to each Plasticity face"
    bl_options = {'REGISTER', 'UNDO'}
